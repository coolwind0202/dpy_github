...
github_token = "38692db872507a527973dbc2ce1f7108dd5230ea"
discord_token = "NTk2ODkwMDgyNTkwNDU3ODU4.XamnqQ.dcaA3PghJWNC1UtUY92JgsytkKI"

@client.event
async def on_ready():
    guild = client.get_guild(623449115178565642)
    reporter = Reporter(guild,github_token,"test-repository")
    reporter.push(commit_title="hello")
    print("pushed")
